...
`
          <div class="field full">
            ...
            <input id="full_name" name="full_name" type="text" value="{{$student->full_name}}" placeholder="Enter full name" required />
          ...
          <div class="field">
            <label>Gender</label>
            <div class="radio-row">
              <label class="radio"><input type="radio" name="gender" value="male" {{ $student->gender=='male'?'checked':'' }}  required> Male</label>
              <label class="radio"><input type="radio" name="gender" value="female" {{ $student->gender=='female'?'checked':'' }}  required> Female</label>
              <label class="radio"><input type="radio" name="gender" value="other" {{ $student->gender=='other'?'checked':'' }}  required> Other</label>
            </div>
          ...
          <div class="field">
            ...
            <input id="age" name="age" value="{{$student->age}}" type="number" min="1" max="120" placeholder="e.g. 20" required />
            <div class="hint">Saved into <b>age</b> column.</div>
          </div>

          <div class="field">
            <label for="phone_number">Phone Number</label>
            <input id="phone_number" value="{{$student->phone_number}}" name="phone_number" type="tel" placeholder="e.g. 012345678" required />
            <div class="hint">Saved into <b>phone_number</b> column.</div>
          </div>

          <div class="field">
            <label for="dob">Date of Birth</label>
            <input id="dob" name="dob" value="{{$student->dob}}" type="date" required />
